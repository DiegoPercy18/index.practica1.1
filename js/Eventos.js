...
var az = document.getElementById("moradito");
az.addEventListener("click", morado);
var ve = document.getElementById("verdesito");
ve.addEventListener("click", verde);
var ve = document.getElementById("azulito");
ve.addEventListener("click", azul);
var ve = document.getElementById("amarillito");
ve.addEventListener("click", amarillo);
var ve = document.getElementById("cafesito");
ve.addEventListener("click", cafe);
var ve = document.getElementById("naranjita");
ve.addEventListener("click", naranja);
